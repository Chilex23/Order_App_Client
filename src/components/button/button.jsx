...
export const ButtonMd = ({ children, clickHandler = () => {} }) => (
  <button
    onClick={clickHandler}
    className="text-sm sm:text-base bg-gradient-to-r from-green-400 to-green-600 px-6 py-2 block my-5 text-white uppercase rounded-md font-semibold hover:shadow-lg hover:scale-105 transition-all"
  >
    {children}
  </button>
);
